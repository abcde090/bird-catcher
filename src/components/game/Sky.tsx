...
import { PHASES, type PhaseConfig } from "../../lib/game-config";
...
export default function Sky({ phase, timeRemaining }: SkyProps) {
  ...
  const colors = phase.sky.map((c, i) =>
    lerpCol(c, next.sky[i] ?? c, blend * 0.7),
  );
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M0 200 L0 130 L80 80 L160 110 L240 70 L340 100 L420 60 L520 90 L620 50 L720 95 L820 70 L920 105 L1020 75 L1100 100 L1200 85 L1200 200 Z"
          fill={phase.horizon}
        />
      </svg>
      <svg
      ...
      >
        <path
          d="M0 200 L0 150 L100 110 L200 140 L300 100 L420 140 L540 90 L680 135 L820 100 L960 140 L1100 110 L1200 130 L1200 200 Z"
          fill={phase.horizon}
      ...
      >
        <path
          d="M0 60 Q 30 20, 60 40 T 120 30 T 180 45 T 240 25 T 300 40 T 360 30 T 420 50 T 480 30 T 540 40 T 600 25 T 660 45 T 720 30 T 780 40 T 840 25 T 900 45 T 960 35 T 1020 40 T 1080 30 T 1140 45 T 1200 35 L 1200 60 Z"
          fill={phase.horizon}
        />
      </svg>
    </div>
...
function CloudLayer({ phaseId }: CloudLayerProps) {
